...
from illustration_generation.stablediffusion.ldm.modules.diffusionmodules.openaimodel import EncoderUNetModel, UNetModel
from illustration_generation.stablediffusion.ldm.util import log_txt_as_img, default, ismap, instantiate_from_config
